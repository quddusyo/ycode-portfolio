  ...
  return (
    <div data-aos="fade-left" className={themeSwitch ? 'about-container container-default' : 'about-container container-default dark-text'}>
        ...
        <p className='p-default'>
          ...
          solving to create robust real-world web applications to help businesses grow. I have experience in many technologies used to create
           websites for my freelance clients.
        </p>
    </div>
  )
}
